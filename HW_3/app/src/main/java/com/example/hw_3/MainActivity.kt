...
fun main(){
    val row = Random.nextInt(1, 5)
    val column = Random.nextInt(1, 5)
    val outerList = mutableListOf(mutableListOf(column))
    val innerList = mutableListOf(column)

    innerList.add(Random.nextInt(1, 100))
...
//    }
    ...
    println("2D List: $outerList")
    println("Index of Column that contains the minimum value : $minimum")

}

fun computePrimes(limit:Int): Int{
    var testList = mutableListOf(50)
    var primeList = mutableListOf(10)

    for (i in 1..testList.size){
